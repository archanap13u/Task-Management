...
function Sidebarr() {
  ...
  return (
    ...
    <div className='w-full h-full flex flex-col gap-6 p-3'>
        ...
        <Link to={'/dash'} className='flex gap-2 px-3 py-2 rounded-full items-center text-grey-800  hover:text-white
           text-base hover:bg-blue-500 '><MdDashboard/>Dashboard</Link>
           <Link to={'/tasks'} className='flex gap-2 px-3 py-2 rounded-full items-center text-grey-800
           text-base hover:bg-blue-500  hover:text-white'><FaTasks/>Tasks</Link>
           ...
           text-base hover:bg-blue-500  hover:text-white'>Tasks</Link>
        </div>
    </div>
    </>
  )
